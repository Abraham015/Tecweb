...
<div class="container">
    <div class="wrapper">
	    ...
	    <center><a href='update.php'><input type='submit' value='Completar registro'/></a>&nbsp;<a href="modificar.php?Boleta=<?php echo $bol ?>"><input type='button' value='Regresar'></a></center>
</body>
</html>
