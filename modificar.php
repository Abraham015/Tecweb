...
<body>
    <table align="center">
      <tr>
        ...
        <td><h1 align="center">&nbsp;Registro de Datos Generales</h1>
...
<div class="container">
    ...
    <fieldset style="background: white; text-align: center; font-family: monserrat;">
        <h2>Identidad :</h2><hr>
        <table align="center">
          <tr>
            <td><label for="boleta">No. de boleta:</label><br>
              <input
                type="text"
                id="boleta"
                name="boleta"
          ...
          <tr>
            <td><br><label for="curp">CURP:</label><br>
              <input
                type="alphanumeric"
                name="curp"
                id="curp"
        ...
        <table align="center">
          ...
          <tr>
            <td>ESCOM fue tu:<br><br></td>
          </tr>
        </table>
        <div align="center" style="position: absolute;top: 1730px;left: 272px;margin: -25px 0 0 -25px;">
